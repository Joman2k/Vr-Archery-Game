...
public class Notch : XRSocketInteractor
{
    ...
    //This controls how far the player needs to pull back

    [Range(0, 1)] public float MaximumreleaseAmount = 0.25f;

    
    public PullMeasurer PullAmount { get; private set; } = null;
    ...
    {
        base.Awake();
        PullAmount = GetComponent<PullMeasurer>();
    ...
    protected override void OnEnable()
    {
        ...
        PullAmount.selectExited.AddListener(ReleaseArrow);

        // Move the attach point for the arrow
        PullAmount.Pulled.AddListener(MoveAttach);
    }

    protected override void OnDisable()
    {
        base.OnDisable();
        PullAmount.selectExited.RemoveListener(ReleaseArrow);
        PullAmount.Pulled.RemoveListener(MoveAttach);
    ...
    public void ReleaseArrow(SelectExitEventArgs args)
    {
        ...
        if (selectTarget is Arrow && PullAmount.PullAmount > MaximumreleaseAmount)
